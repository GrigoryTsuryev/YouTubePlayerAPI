package com.tsuryev.youtubeplayer;
...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String YOUTUBE_VIDEO_ID = "HqqKlPa3oxo";
    static final String YOUTUBE_PLAYLIST = "PLUJndYuJhSgzKCff-E7is6JerxmOljUDL";
